package com.example.crmsystemmono.common.security.config;


import com.example.crmsystemmono.application.domain.model.Role;
import com.example.crmsystemmono.common.security.filter.*;
import lombok.*;
...
//                        .requestMatchers("/api/v1/**").permitAll()
                        .requestMatchers("/api/v1/auth/**").permitAll()
                                .requestMatchers(HttpMethod.POST,"/api/v1/company/**").hasAuthority(Role.ADMIN.name())
                                .requestMatchers(HttpMethod.PUT,"/api/v1/company/**").hasAuthority(Role.ADMIN.name())
                                .requestMatchers(HttpMethod.POST,"/api/v1/group/**").hasAuthority(Role.ADMIN.name())
                                .requestMatchers(HttpMethod.GET,"/api/v1/group/**").hasAuthority(Role.ADMIN.name())
                                .requestMatchers(HttpMethod.GET,"/api/v1/group/**").hasAuthority(Role.USER.name())
                                .requestMatchers(HttpMethod.POST,"/api/v1/stage/**").hasAuthority(Role.ADMIN.name())
                                .requestMatchers(HttpMethod.GET,"/api/v1/stage/**").hasAuthority(Role.ADMIN.name())
                                .requestMatchers(HttpMethod.GET,"/api/v1/stage/**").hasAuthority(Role.USER.name())
